...
The seventh aim of the AI LABS is to implement Naive Bayes Algorithm to predict the probability of an event, based on prior knowledge of conditions that might be related to the event.
